...
export const ENTRY_TYPES = {
  ...
  event: {
    ...
    fields: [
      { key: 'dateText', label: 'Date / Approximate Date', type: 'text' },
      { key: 'era', label: 'Era', type: 'text' },
      { key: 'duration', label: 'Duration', type: 'text' },
      { key: 'timelineOrder', label: 'Timeline Sort Order (optional)', type: 'number' },
  ...
  mystery: {
    ...
    fields: [
      ...
      { key: 'whenIntroduced', label: 'When Introduced', type: 'text' },
      { key: 'initialClue', label: 'Initial Clue', type: 'textarea' },
      { key: 'additionalClues', label: 'Additional Clues', type: 'textarea' },
      ...
      { key: 'revealPoint', label: 'Book / Chapter Revealed', type: 'text' },
      { key: 'consequences', label: 'Consequences', type: 'textarea' }
    ]
  },
  foreshadowing: {
    ...
    fields: [
      ...
      { key: 'chapter', label: 'Chapter / Scene', type: 'text' },
...
export const RELATION_TYPES = [
  ...
  'appears_in', 'introduced_in', 'clue_in', 'revealed_in', 'foreshadows', 'contradicts', 'supports'
];
